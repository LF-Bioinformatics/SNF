...
public class Tools {
    ...
    public static String TOP_DIR = "TOP_DIR";
    ...
    public static String SCRIPTS_DIR = "SCRIPTS_DIR";
    public static String LOGS_DIR = "LOGS_DIR";
    ...
    public Tools(){
        if(this.isDefaultConfigFilePresent()){
            this.defaultPropsFile = new File("./depend/properties.config");
    ...
    public void setUpUserProperties(){
        ...
        this.userProps.setProperty(Tools.TOP_DIR, this.getTopDir());
        this.userProps.setProperty(Tools.DEPEND_DIR, this.getInstallDir());
        this.userProps.setProperty(Tools.SCRIPTS_DIR, this.userProps.getProperty(Tools.DEPEND_DIR)+"/scripts");
        this.userProps.setProperty(Tools.LOGS_DIR, this.userProps.getProperty(Tools.DEPEND_DIR)+"/logs");
        this.userProps.setProperty(Tools.USER_CONFIG, this.userProps.getProperty(Tools.DEPEND_DIR)+"/user.config");
        try (FileOutputStream out = new FileOutputStream(this.userProps.getProperty(Tools.USER_CONFIG))) {
            userProps.store(out, "---USER CONFIGURATION INITIAL INSTALL---");
        } catch (IOException ex) {
            Logger.getLogger(Tools.class.getName()).log(Level.SEVERE, null, ex);
        }   
    }
    ...
    public void installCondaEnvironmentAsRequired(){
        if(this.isCondaInstallRequestedByUser()){
            ...
            this.userProps.setProperty(Tools.INSTALL_LOG, this.userProps.getProperty(Tools.LOGS_DIR)+"/install.log.txt");
            FileUtils f = new FileUtils();
            String makeDirs = "mkdir " + this.userProps.getProperty(Tools.SCRIPTS_DIR) + Tools.nl() + "mkdir "+this.userProps.getProperty(Tools.LOGS_DIR) + Tools.nl();    
            f.command(makeDirs, new File(this.getInstallDir()), "I_01", true);
            String cmd = "";
            cmd += "cd " + this.userProps.getProperty(Tools.SCRIPTS_DIR) + Tools.nl()
            ...
            f.command(cmd, new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)),"I_01", false);
            
            StringBuilder testEnv = this.getCommandBuilder().append("conda info --envs").append(Tools.nl()); 
            f.command(testEnv.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)),"I_02", false); 
            ...
            this.userProps = new Properties();
            try (FileInputStream in = new FileInputStream("./depend/user.config")) {
    ...
    public void installCondaTools() {
        if(this.isCondaToolsInstallRequestedByUser()){
            ...
            f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)),"I_03", false);
        }
    }
    ...
    public void installPatmanAsRequested(){
        if(this.isPatmanInstallationRequestedByUser()){
            ...
            FileUtils f = new FileUtils();
            StringBuilder cmd = this.getCommandBuilder()
                .append("cd ").append(this.userProps.getProperty(Tools.SCRIPTS_DIR)).append(Tools.nl())
                ...
                .append(this.userProps.getProperty("SCRIPTS_DIR")).append("/patman-1.2.2/patman -V").append(Tools.nl());
            f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)),"I_04", false); 
            this.userProps.setProperty(Tools.PATMAN, this.userProps.getProperty(Tools.SCRIPTS_DIR)+"/patman-1.2.2/patman");
            this.defaultProps.setProperty(Tools.PATMAN, this.userProps.getProperty(Tools.SCRIPTS_DIR)+"/patman-1.2.2/patman");
    ...
    public void setUpRunDir(String runID){
        System.out.println("Setting up run directory.");
        FileUtils f = new FileUtils();
        this.userProps.setProperty(Tools.RUN_DIR, this.getTopDir()+"/"+runID);
        ...
        StringBuilder cmd = this.getCommandBuilder()
            .append("mkdir ").append(this.userProps.getProperty(Tools.RUN_DIR)).append(Tools.nl())
        ...
        f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)),"01.0", false);
        try (FileOutputStream out = new FileOutputStream(this.userProps.getProperty(Tools.USER_CONFIG))) {
    ...
    public File runGRF(File genomeFasta, float ratio){
        ...
        f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)),"02.0", false);
    ...
    public void runFastQCPre(String runID, String arg) {
        ...
        if(arg.contains(",")){
            ...
            for (String fastq : fastqs) {
                ...
                f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)),"03.0",false);
            }
        }else{
            StringBuilder cmd = this.getCommandBuilder()
            ...
            f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)), "03.1", false);
        }
    ...
    public File runFastqsToSingleUncompressedFastq(String arg) {
        ...
        if(arg.contains(",")) {
            ...
            f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)), "04.0", false);
        } else {
            if(arg.contains(".gz")){
                cmd.append("gunzip ").append(arg).append(Tools.nl());
                f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)), "04.1", false);
    ...
    public File runTrimAdapters(File fastq, boolean HD, String adapter){
        ...
        f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)), "05.0", false);
    ...
    public File runFastqToFasta(File fastq){
        ...
        f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)), "06.0", false);
    ...
    public File runPatman(File patterns, File database){
        ...
        StringBuilder cmd = this.getCommandBuilder()
                ...
                .append(this.userProps.getProperty(Tools.PATMAN)).append(" -s -e 0 -g 0 -D ").append(database.getAbsolutePath()).append(" -P ").append(patterns.getAbsolutePath())
                .append(" -o ").append(patterns.getName()).append(".patman.aln \n");
        f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)),"07.0", false);
    ...
    public void runBuildBlastGeneDatabase(File genesFasta) {
        ...
        FileUtils f = new FileUtils();
        f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)), "08.0", false);
    ...
    public File runBlastn() {
        ...
        FileUtils f = new FileUtils();
        f.command(cmd.toString(), new File(this.userProps.getProperty(Tools.SCRIPTS_DIR)), "09.0", false);
    ...
    private String getInstallDir(){
        return new File("./depend").getAbsolutePath();
    }

    private String getTopDir(){
    ...
    private boolean isDefaultConfigFilePresent() {
        File d = new File(this.getInstallDir()+"/properties.config");
